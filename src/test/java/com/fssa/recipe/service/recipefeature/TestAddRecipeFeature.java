...
public class TestAddRecipeFeature {
    ...
    public void testAddRecipeSuccess() {
        ...
        Recipe recipe = new Recipe(1, "Tomato", "Delicious pasta dish with bacon and cream sauce.",
...
//       RecipeService recipeService = new RecipeService();
//        Recipe recipe = new Recipe(2,"Chocolate Chip Cookies", "Classic homemade chocolate chip cookies.",
